          ...
          child: BlocConsumer<GameBloc, GameState>(
            ...
            builder: (context, state) {
              if (state is GameInitial || state is QuestionLoading) {
                ...
                // Force a rebuild for animation when question changes
                return AnimatedSwitcher(
                  ...
                  transitionBuilder: (Widget child, Animation<double> animation) {
                     // Custom slide + fade
                    final inOffset = Tween<Offset>(begin: const Offset(0.2, 0), end: Offset.zero).animate(animation);
                    final outOffset = Tween<Offset>(begin: const Offset(-0.2, 0), end: Offset.zero).animate(animation);
                    final fade = Tween<double>(begin: 0.0, end: 1.0).animate(animation);

                    return FadeTransition(
                      opacity: fade,
                      child: SlideTransition(
                        position: child.key == ValueKey(currentRound) ? inOffset : outOffset,
                         child: child,
                      ),
                    );
                  },
                                    ...
                                    actions: [
                                      ...
                                      TextButton(
                                        ...
                                        child: Text(
                                          ...
                                          style: const TextStyle(color: Color(0xFFFF2B5E), fontWeight: FontWeight.bold),
                                        ),
                                      ),
                                    ],
                                  ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: const Color(0xFF252538).withValues(alpha:0.8),
                                  borderRadius: BorderRadius.circular(24),
                                  border: Border.all(
                                    color: const Color(0xFFD300F9).withValues(alpha:0.5),
                                    width: 2,
                                  ),
                                  boxShadow: [
                                    BoxShadow(
                                      color: const Color(0xFFD300F9).withValues(alpha:0.2),
                                      blurRadius: 20,
                                      spreadRadius: 2,
                                    )
                                  ],
                              ...
                              ...List.generate(4, (index) {
                                Color backgroundColor = const Color(0xFF252538);
                                ...
                                if (state is AnswerSubmitted) {
                                  if (index == q.correctAnswerIndex) {
                                    ...
                                    borderColor = const Color(0xFF69F0AE);
                                      ...
                                      !isCorrect!) {
                                    backgroundColor = const Color(0xFFFF2B5E); // Error Red
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    child: ElevatedButton(
                                      style: ElevatedButton.styleFrom(
                                        ...
                                        elevation: state is AnswerSubmitted && (index == q.correctAnswerIndex || index == selectedIndex) ? 8 : 2,
                                        shadowColor: borderColor.withValues(alpha:0.5),
                                        shape: RoundedRectangleBorder(
                                          borderRadius: BorderRadius.circular(16),
                                          side: BorderSide(color: borderColor, width: state is AnswerSubmitted && (index == q.correctAnswerIndex || index == selectedIndex) ? 2 : 1),
                                        ),
                                      ),
                                ...
                                ).animate(delay: (100 * index).ms).fadeIn().slideY(begin: 0.5, end: 0);
                              }),
                            ],
                          ),
                        ),
                            ...
                            child: ElevatedButton(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Icon(
                                    currentRound == totalRounds ? Icons.flag : Icons.arrow_forward_rounded, 
                                    size: 28,
                                  ),
                                ],
                              ),
